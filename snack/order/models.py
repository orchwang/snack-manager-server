...
class Snack(models.Model):
    ...
    name = models.CharField(max_length=128, blank=True, help_text="Snack name.")
    url = models.CharField(
        max_length=500, blank=True, help_text="A url for buy the snack."
    )
    image = models.ImageField(upload_to=snack_image_path)
    currency = models.CharField(
        max_length=4, choices=Currency.choices, default=Currency.KRW
    )
